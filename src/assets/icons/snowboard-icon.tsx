export const SnowboardIcon = () => {
  const scaleBoard = 0.08;

  const strokeWidthBoard = 100;
  const translateX = 100;
  const translateY = -10;

  return (
    <svg className="cursor-pointer" width="30" height="30" viewBox="0 0 300 300" xmlns="http://www.w3.org/2000/svg">
    ...
    c13.27,66.76,11.07,136.33,9.83,204.08C842.42,1158.88,812.86,1637.89,816.43,2097.62"
        ...
        <text
          ...
          fill="#b3b2a0"
          fontWeight="bold"
          transform={`translate(${480}, ${1800}) scale(${1})`}
        >
          ?
        </text>
      </g>
