...
export const BackLegendTop = ({ color, width, height }: IPropsLegendTop) => {
  const scaleText = 1.0;
  const scaleS = 0.07;
  // const positionLegendMiddleSX = isBack ? 3770 : 4750;
  const positionLegendMiddleSX = 4750;
  const positionLegentMiddleSY = -1650;
