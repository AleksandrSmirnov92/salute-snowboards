import { LegendSize148 } from './legend-bottom-size/legend-size-148';
import { LegendSize151 } from './legend-bottom-size/legend-size-151';
import { LegendSize155 } from './legend-bottom-size/legend-size-155';
import { LegendSize155W } from './legend-bottom-size/legend-size-155W';
import { LegendSize158 } from './legend-bottom-size/legend-size-158';
import { LegendSize158W } from './legend-bottom-size/legend-size-158W';
...
export const LegendBottom = ({ color, width, height, modelSize }: IPropsLegendBottom) => {
